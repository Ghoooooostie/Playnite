...
1. Install Playnite.
2. Copy `Switch_Local_Metadata_B49F4F91-73E2-46E8-B66E-3D09BD6BE2FA_1_2.pext` to the computer.
...
- Version 1.2 reads NSP file tables and copies only small NCA files needed for control metadata.
